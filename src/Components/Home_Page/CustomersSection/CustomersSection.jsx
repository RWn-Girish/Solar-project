...
const CustomerSection = () => {
    const logos = [
         Customers_2, Customers_3, Customers_4,
        Customers_5, Customers_6, Customers_7, Customers_8,
        Customers_9,  Customers_12
      ];
      ...
      return (
        <section className="customer-section">
          <h4 className="section-subtitle-customers text-primary">— CUSTOMERS —</h4>
          <h2 className="section-title-customers">Our Valued Customers</h2>
